<?php 
   ...
   $select_two =" select * FROM publishies where idPublish='$pub_id' LIMIT $limit OFFSET $offset";
   $query_two=mysqli_query($link,$select_two);
   $num_two=mysqli_num_rows($query_two);


   $select_three="select count(*) FROM books where _PublishID='$pub_id'";
...
<div class="breadcrumb flat">
	...
	<a href="#" class="active"><?php echo $row_two["_NamePublish"]; ?></a>
    </div>
<div class="row">
<?php
    if(isset($_GET['pub_id'])){
        $select =" select * FROM books where _PublishID='$pub_id'  LIMIT $limit OFFSET $offset";
