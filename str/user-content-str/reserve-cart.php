    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <form action="#">
                    <div class="table-content table-responsive cart-table-content" style="display: block; width:100%; overflow:unset;">
                        <table>
                            <thead>
                                <tr>
                                    <th>Дата</th>
                                ...
                                ?>
                                    <tr class="book<?php echo $row['IdBooks']; ?>">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="#"><img class="img-responsive ml-3" src="../img/img_books/<?php echo $row['_Photo']; ?>" alt=""></a>
                                        </td>
